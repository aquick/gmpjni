...
#include <jni.h>
/* Header for class org_gmplib_gmpjni_GMP_randstate_t */

#ifndef _Included_org_gmplib_gmpjni_GMP_randstate_t
#define _Included_org_gmplib_gmpjni_GMP_randstate_t
#ifdef __cplusplus
extern "C" {
#endif
/*
