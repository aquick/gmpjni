  ...
  (JNIEnv *env, jclass cl, jlong x, jint base)
{
    ...
    buffer = (char *)malloc( (mpz_sizeinbase(*xptr, base) + 2)*sizeof(char) );
    if (buffer != NULL) {
  ...
  (JNIEnv *env, jclass cl, jlong x, jint base)
{
    ...
    buffer = (char *)malloc( (mpz_sizeinbase (mpq_numref(*xptr), base)
                               + mpz_sizeinbase (mpq_denref(*xptr), base) + 3)*sizeof(char) );
    if (buffer != NULL) {
