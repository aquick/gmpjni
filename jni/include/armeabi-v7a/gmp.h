...
#define __GMP_CFLAGS "-O2 -g -pedantic -fomit-frame-pointer -Wa,--noexecstack -ffunction-sections -funwind-tables -no-canonical-prefixes -fno-strict-aliasing -fstack-protector -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -isystem c:\\android-ndk-r21\\sysroot\\usr\\include -isystem c:\\android-ndk-r21\\sysroot\\usr\\include\\arm-linux-androideabi --sysroot=c:\\android-ndk-r21\\toolchains\\llvm\\prebuilt\\windows-x86_64\\sysroot -D__ANDROID_API__=19"
