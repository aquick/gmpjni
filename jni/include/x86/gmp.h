...
#define __GMP_CFLAGS "-O2 -g -pedantic -Wa,--noexecstack -fomit-frame-pointer -ffunction-sections -funwind-tables -fstrict-aliasing -funswitch-loops -finline-limit=300 -no-canonical-prefixes -fstack-protector -march=i686 -mtune=intel -mssse3 -mfpmath=sse -m32 -isystem c:\\android-ndk-r20\\sysroot\\usr\\include -isystem c:\\android-ndk-r20\\sysroot\\usr\\include\\i686-linux-android --sysroot=c:\\android-ndk-r20\\toolchains\\llvm\\prebuilt\\windows-x86_64\\sysroot -D__ANDROID_API__=19"
