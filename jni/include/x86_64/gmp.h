...
#define __GMP_CFLAGS "-O2 -g -pedantic -Wa,--noexecstack -fomit-frame-pointer -ffunction-sections -funwind-tables -fstrict-aliasing -funswitch-loops -finline-limit=300 -no-canonical-prefixes -fstack-protector-strong -march=x86-64 -msse4.2 -mpopcnt -m64 -mtune=intel -isystem c:\\android-ndk-r21b\\sysroot\\usr\\include -isystem c:\\android-ndk-r21b\\sysroot\\usr\\include\\x86_64-linux-android --sysroot=c:\\android-ndk-r21b\\toolchains\\llvm\\prebuilt\\windows-x86_64\\sysroot -D__ANDROID_API__=21"
